...
{ 
  ...
  int id;
	...
	strcpy(s,argv[1]);
  10:	e24b004c 	sub	r0, fp, #76	; 0x4c
  14:	e5911004 	ldr	r1, [r1, #4]
  18:	eb000011 	bl	64 <strcpy>
	argv++;
  id = fork();
  1c:	eb0000a8 	bl	2c4 <fork>

	
    if (id == 0) { 
  20:	e3500000 	cmp	r0, #0
  24:	1a000008 	bne	4c <main+0x4c>
      trace();
  28:	eb0001c3 	bl	73c <trace>
      exec(s, argv); 
  2c:	e2841004 	add	r1, r4, #4
  30:	e24b004c 	sub	r0, fp, #76	; 0x4c
  34:	eb00010a 	bl	464 <exec>
      printf(1, "Child: WE DON'T SEE THIS\n"); 
  38:	e3001b94 	movw	r1, #2964	; 0xb94
  3c:	e3a00001 	mov	r0, #1
  40:	e3401000 	movt	r1, #0
  44:	eb00020c 	bl	87c <printf>
      exit();  
  48:	eb0000aa 	bl	2f8 <exit>
    } else { 
      id = wait(); 
  4c:	eb0000b6 	bl	32c <wait>
      printf(1, "Parent: child terminated\n"); 
  50:	e3001bb0 	movw	r1, #2992	; 0xbb0
...
00000770 <printint>:
 ...
 780:	e3009bcc 	movw	r9, #3020	; 0xbcc
...
00000ab8 <malloc>:
 ...
 abc:	e3007be8 	movw	r7, #3048	; 0xbe8
